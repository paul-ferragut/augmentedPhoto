...
// depth camera
void customLight::setNearClip(float nearFloat){
    ofCamera::setNearClip(nearFloat);
}

float customLight::getNearClip(){
    return ofCamera::getNearClip();
}

void customLight::setFarClip(float farFloat){
    ofCamera::setFarClip(farFloat);
}
